...
import pygame
from Game_running_package.messages_windowed import display_scoreW


class TestMessageDisplayWindowed(unittest.TestCase):

    @patch('pygame.font.Font')
    @patch('pygame.display.get_surface')
    def test_display_scoreW(self, mock_get_surface, mock_font):
        ...
        # Call the display_scoreW function
        display_scoreW(100, 200, 12345)
